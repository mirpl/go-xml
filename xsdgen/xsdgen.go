package xsdgen // import "github.com/mirpl/go-xml/xsdgen"
...
import (
	...
	"github.com/mirpl/go-xml/internal/dependency"
	"github.com/mirpl/go-xml/internal/gen"
	"github.com/mirpl/go-xml/xmltree"
	"github.com/mirpl/go-xml/xsd"
)
...
func (cfg *Config) genComplexType(t *xsd.ComplexType) ([]spec, error) {
	...
	for _, el := range elements {
		...
		tag := fmt.Sprintf(`json:"%s" xml:"%s:%s%s"`, strings.ToLower(el.Name.Local[:1])+el.Name.Local[1:], "urn", el.Name.Local, options)
